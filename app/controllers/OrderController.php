...
class OrderController extends BaseController {
	...
	{
		$image_id = Input::get('order_image_id');
		$image_name = Input::get('order_image_name');
		...
		if( Request::ajax() ) {
			...
			$arrReturn = ['status' => 'ok', 'message' => 'Cart added successfully.'];
	...
	{
		$sku = Input::has('sku')?Input::get('sku'):'WEB-818';
