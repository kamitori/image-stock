...
<div class="modal fade" id="modal_remove" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Are you sure you want to remove the selected images from this lightbox?</p>
			</div>
			<div class="modal-footer">
...
<script>
	...
	function deleteImageLightbox(obj){
		var id_lightbox = $("#id_lightbox").val();
		var arr_images = [], list_image = [];
		var delete_lightbox = false;

		$(".checkbox_image").each(function(){
			arr_images.push(parseInt($(this).val()));
		})
		...
		//alert(arr_images.length);
		if(list_image.length==arr_images.length){
