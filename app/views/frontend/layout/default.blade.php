...
<html lang="en">
  <head>
	...
	<meta property="fb:admins" content="100004566721915"/>
  ...
  <body>
	...
	<div class="container search_bar">
		<form class="form-inline" action="{{URL}}/search" method="GET" enctype="application/x-www-form-urlencoded" id="search-form">
			...
			<input type="hidden">
			<input type="hidden">
			<div class="col-md-3 form-group logo">
				<a href="{{URL}}"><img src="{{URL}}/assets/images/logo2.png" alt="logo" id="logo" /></a>
			</div>
			<div class="col-md-6 form-group search_box">
	...
	<script>
		...
		var availableKeywords = $.map({{ json_encode($arr_search_names) }}, function(el) { return el; });
