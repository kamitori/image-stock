...
<nav class="navbar navbar-default navbar-menu">
  <div class="container">
	  ...
	  <ul class="nav navbar-nav navbar-right">
		<li class="dropdown active">
			...
			<ul class="dropdown-menu" role="menu">
                ...
                @endif
                <li><a href ="{{URL}}/user-reference/{{$user->id}}/{{Str::slug($user->first_name)}}.html"><span class="fa fa-users"></span>&nbsp; User's References</a></li>
                <li><a href ="{{URL}}/lightbox"><span class="fa fa-lightbulb-o"></span>&nbsp; Lightboxes</a></li>
                <li><a href ="{{URL}}/account/profile"><span class="fa fa-user"></span>&nbsp; Profile</a></li>
				...
				<li style="  width: 300px;">
					<div class="col-md-12">
						<form name="formSignin" action="{{ URL::route('account-sign-in-post') }}" method="post" class="form-signin" style="border-bottom: 1px solid #e7e7e7;margin-bottom: 15px;">
	                		...
	                		<small><a  title="Forgot your password" href="{{ URL.'/account/forgot' }}">Forgot your password?</a></small>
	...
	@endif
    <ul class="nav navbar-nav navbar-right">
    	<li><a href="/cart"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;Your Cart @if($cart_count>0)<small>({{$cart_count}})</small>@endif</a></li>
	</ul>
