...
<span id="result_search">
	@if(empty($images))
		<h4 class="container">We could not find any images. Please try again with another options.</h4>
	@else
		<h4 class="container">We have found {{ $total_image>1?$total_image.' images': '1 image' }}</h4>
	@endif
</span>
