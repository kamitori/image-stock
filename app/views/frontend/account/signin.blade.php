        ...
        <div class="account-wall">
            <form name="formSignin" action="{{ URL::route('account-sign-in-post') }}" method="post" class="form-signin">
                ...
                <div class="form-group">
                    ...
                    @if(isset($errors) && $errors->has('emailLogin'))
                ...
                <div class="form-group">
                    ...
                    @if(isset($errors) && $errors->has('passwordLogin'))
                ...
                <a class="col-md-6" title="Forgot your password" href="{{ URL.'/account/forgot' }}">Forgot your password?</a>
