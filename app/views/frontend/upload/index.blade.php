...
<div class="container-fluid">
    ...
    <!-- Page Content -->
    <div class="container">
		<div class="row col-lg-10 col-lg-offset-1 text-left">
            <!-- Page Header -->
            <div class="row">
                <div>
            ...
            @if(count($files)>0)
                ...
                <div class="row">
                @endif
                    <div class="col-md-3 portfolio-item" style="padding-left:5px; padding-right:5px;">
                              ...
                              <a href="javascript:void(0)" style="cursor:default">                          
                                <img class="img-responsive" src="{{URL}}{{ $file['path'] }}" alt="{{ $file['name'] }}" style="height:100%; width:100%" />
                                  <div class="pdf-thumb-box-overlay">
                                    ...
                                    <div><span class="glyphicon glyphicon-remove-sign" style="cursor:pointer" onclick="delete_file('{{ Str::slug($file['name']) }}', '{{ $file['image_id'] }}', '{{ $current }}')"></span></div>
                                  </div>                            			        
                              </a>                                    
                        </div>
                        <div>
