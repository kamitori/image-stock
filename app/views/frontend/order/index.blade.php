...
<div class="panel panel-default col-lg-8 col-lg-offset-2" style="padding:0;">
	<div class="panel-heading hc2 abel bold">
		<h3>Shoping Cart</h3>
	</div>
		...
		<div class="panel-footer">
			<div class="row" style="margin:0;">
                ...
                @endif
                	<a href="{{URL::previous()}}"><button type="button" class="btn btn-primary"><i class="icon-ok-sign"></i> Continue shopping</button></a>
