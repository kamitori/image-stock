                                    ...
                                    <form name="billing-form" action="/payment/add-address" method="post">
                                      ...
                                      <fieldset>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="tel" class="form-control" name="phone" id="phone" placeholder="Enter Phone" value="{{ isset($billing_address['phone']) ? $billing_address['phone'] : '' }}" required >
                                        </div>                                        
                                        <div class="form-group">
                                ...
                                <!-- FORM -->
                                    <form name="shipping-form" action="/payment/add-address" method="post">
                                      ...
                                      <fieldset>
                                        ...
                                        <div class="form-group">
                                          <label for="phone">Phone</label>
                                          <input type="tel" class="form-control" name="phone" id="phone" placeholder="Enter Phone" value="{{ isset($shipping_address['phone']) ? $shipping_address['phone'] : '' }}" required >
                                        </div>                                                                                
                                        <div class="form-group">
                                          <label for="street">Adress 1</label>
