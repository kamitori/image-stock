<div style="margin-top:20px;">
	...
	<div class="collapse navbar-collapse" id="navigator">
    	<ul class="nav nav-tabs left" style="margin-top:-5px; color:#333;"><h4>{{$image_obj->short_name}}'s Similar Images</h4></ul>
		<ul class="pagination">
...
<script>
	...
	var load_url = "/similar-images/{{ $image_obj->id }}/{{$image_obj->short_name}}.html";
