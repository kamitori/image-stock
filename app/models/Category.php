...
class Category extends BaseModel {
    ...
    public function scopeWithUserImages($query, $user_id)
    {
        return $query->addSelect('images.*')
        			->join('images_categories', 'images_categories.category_id', '=', 'categories.id')
        			->join('images', 'images.id', '=', 'images_categories.image_id')
